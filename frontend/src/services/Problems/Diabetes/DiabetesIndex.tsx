...
function DiabetesIndex() {
  ...
  if (!hasDiabetes ){
    if(hba1c !==undefined && hba1c !== 0){
      if (hba1c<5.6) return <li><strong>DM </strong> Ausente</li>
      if (hba1c<6.5) return <li><strong>DM </strong> Pré-diabetes</li>
      if (hba1c>= 6.5) return <li><strong>DM </strong> Diabetes presente?</li>
    }
  ...
  if(hasDiabetes){
    if(hba1c !== undefined){
      if (hba1c ===0 ) return <li><strong>DM </strong></li>
      if (hba1c< 7.0) return <li><strong>DM </strong> (controlado)</li>
      if (hba1c >= 7) return <li><strong>DM </strong> (descontrolado)</li>
      return <li><strong>DM </strong></li>
    }
  }
}
